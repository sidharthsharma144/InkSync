...
class designController {
    create_user_design = async (req, res) => {
        ...
        try {
            ...
            const design = await designModel.create({
                components: [],
                image_url: 'https://www.carscoops.com/wp-content/uploads/2022/04/Koenigsegg-Jesko-Absolut-1c-768x416.jpg'
            })
    ...
    add_user_image = async (req, res) => {
        ...
        try {
            ...
            const userImage = await userImageModel.create({
                user_id: 'dummy_user_id',  // Hardcoded user ID
                image_url: url
            })
    ...
    get_user_image = async (req, res) => {
        try {
            const images = await userImageModel.find({ user_id: 'dummy_user_id' })
